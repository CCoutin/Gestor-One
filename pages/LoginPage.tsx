...
import { LockClosedIcon, IdentificationIcon, KeyIcon, UserIcon } from '../components/icons/HeroIcons';
...
const LoginPage: React.FC = () => {
  ...
  const handleVisitorLogin = async () => {
      ...
      setError(null);
      try {
          await login(UserRole.VISITANTE, 'VISITANTE', '123');
      } catch (err: any) {
        ...
        <div className="w-full max-w-sm p-8 space-y-8 bg-white shadow-2xl rounded-2xl">
          ...
          <div className="space-y-3">
            ...
            <div className="relative flex py-2 items-center">
                ...
                <span className="flex-shrink-0 mx-4 text-slate-400 text-xs">Acesso Rápido</span>
                <div className="flex-grow border-t border-slate-300"></div>
            </div>
             ...
             <button
              ...
              disabled={isLoading}
              className="w-full flex justify-center items-center py-3 px-4 border-2 border-emerald-500 rounded-md shadow-sm text-sm font-bold text-emerald-600 bg-white hover:bg-emerald-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-transform hover:scale-105"
            >
