...
// FIX: Import AIRevenueForecast from types.ts to resolve module export error.
import { forecastNextMonthRevenue } from '../services/geminiService';
import { AIRevenueForecast } from '../types';
