...
const credentials = {
  ...
  [UserRole.VISITANTE]: [{ code: 'VISITANTE', password: '123' }],
};
    ...
    return new Promise((resolve, reject) => {
      ...
      setTimeout(() => {
        ...
        if (isValid) {
          ...
          if (role === UserRole.DIRETOR) userName = 'Alice';
          else if (role === UserRole.GERENTE) userName = 'Beto';
          else if (role === UserRole.OPERADOR) userName = 'Carlos';
          else if (role === UserRole.VISITANTE) userName = 'Visitante VIP';
