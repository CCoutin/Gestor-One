...
interface DatabaseContextType {
  ...
  resetDatabase: () => void; // Nova função para resetar manualmente se necessário
}
...
export const DatabaseProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const initializeState = <T,>(key: string, fallback: T): T => {
      ...
      try {
          ...
          // Se a versão mudou, ignoramos o localStorage e retornamos o mock (fallback)
          // Isso garante que as novas regras de negócio (500k, imagens) sejam aplicadas.
