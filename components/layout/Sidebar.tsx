...
const Sidebar: React.FC<SidebarProps> = ({ activePage, setActivePage }) => {
  ...
  const navLinks: { page: Page; icon: React.ReactElement<{ className?: string }>; label: string; roles: UserRole[] }[] = [
    ...
    { page: 'inventario', icon: <ClipboardDocumentCheckIcon />, label: 'Inventário', roles: [UserRole.OPERADOR, UserRole.GERENTE, UserRole.DIRETOR, UserRole.VISITANTE] },
    { page: 'parceiros', icon: <BuildingStorefrontIcon />, label: 'Parceiros', roles: [UserRole.GERENTE, UserRole.DIRETOR, UserRole.VISITANTE] },
    { page: 'colaboradores', icon: <UsersIcon />, label: 'Colaboradores', roles: [UserRole.DIRETOR, UserRole.VISITANTE] },
    { page: 'relatorios', icon: <DocumentChartBarIcon />, label: 'Relatórios', roles: [UserRole.GERENTE, UserRole.DIRETOR, UserRole.VISITANTE] },
    { page: 'gerenciar-acessos', icon: <ShieldCheckIcon />, label: 'Gerenciar Acessos', roles: [UserRole.DIRETOR, UserRole.VISITANTE] },
    { page: 'notas', icon: <DocumentTextIcon />, label: 'Notas Fiscais', roles: [UserRole.DIRETOR, UserRole.VISITANTE] },
    { page: 'faturamento', icon: <CurrencyDollarIcon />, label: 'Faturamento', roles: [UserRole.DIRETOR, UserRole.VISITANTE] },
  ];
